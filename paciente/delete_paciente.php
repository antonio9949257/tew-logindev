      ...
      <div class="col-md-6">
        <div class="card bg-secondary text-light">
          <div class="card-header">
            <h2 class="card-title mb-0"><i class="fas fa-trash"></i> Eliminar Paciente</h2>
          </div>
          <div class="card-body">
            <?php echo $message; ?>
            <p>¿Estás seguro de que quieres eliminar al paciente <strong><?php echo htmlspecialchars($paciente['nombre']) . ' ' . htmlspecialchars($paciente['apellido']); ?></strong>?</p>
            <form action="delete_paciente.php?id=<?php echo $id; ?>" method="post">
