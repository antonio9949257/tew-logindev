...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(30, 10, 'Listado de Especialidades', 0, 0, 'C');
        // Fecha
    ...
    function FancyTable($header, $data)
    {
        ...
        // Cabecera
        $w = array(185); // Anchos de las columnas
...
// Cargar datos
$sql = "SELECT nombre FROM especialidad ORDER BY nombre";
...
$header = array('Nombre de la Especialidad');
