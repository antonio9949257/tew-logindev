...
<body class="bg-dark text-light">
  ...
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <div>
        <a href="create_especialidad.php" class="btn btn-primary"><i class="fas fa-plus"></i> Agregar Nueva Especialidad</a>
        ...
        <tbody>
          ...
          if ($res->num_rows > 0) {
              while($fila = $res->fetch_assoc()) {
                  ...
                  echo "<td>";
                  echo "<a href='edit_especialidad.php?id=" . $fila["id"] . "' class='btn btn-sm btn-warning me-2'><i class='fas fa-edit'></i> Editar</a>";
                  echo "<a href='delete_especialidad.php?id=" . $fila["id"] . "' class='btn btn-sm btn-danger'><i class='fas fa-trash'></i> Eliminar</a>";
                  echo "</td>";
                  echo "</tr>";
              }
          } else {
              echo "<tr><td colspan='2' class='text-center'>No se encontraron especialidades</td></tr>";
          }
          $con->close();
          ?>
        </tbody>
